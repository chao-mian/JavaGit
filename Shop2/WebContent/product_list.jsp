	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${productList }" var="product">
			<div class="col-md-2" style="height: 250px">
				<a
					href="${pageContext.request.contextPath}/productInfo/${product.pid}">
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
		  ...
		  -->
			<c:if test="${pageBean.currentPage!=1 }">
				<li><a
					href="${pageContext.request.contextPath }/product?currentPage=${pageBean.currentPage-1}"
		 ...
		 怎么判断当前是哪一页？
		  -->
			<c:forEach begin="1" end="${pageBean.totalPage }" var="pageNum">
				...
				<c:if test="${pageBean.currentPage!=pageNum }">
					<li><a
						href="${pageContext.request.contextPath }/product?currentPage=${pageNum}">${pageNum }</a></li>
				</c:if>
